...
import { ValidationResult, ValidationIssue, REQUIRED_COMPONENTS } from '@/lib/strategy/strategyValidator';
...
export default function ValidationStatus({ validation, onNavigateToIssue }: ValidationStatusProps) {
  const { completionScore, requiredMissing, recommendedMissing, errors, warnings } = validation;

  return (
    <div className="space-y-4">
      {/* Completion Progress */}
      <CompletionProgress score={completionScore} isComplete={validation.isComplete} />
      ...
      {validation.isComplete && recommendedMissing.length > 0 && (
        <ValidationIssues 
          title="Recommended" 
...
const REQUIRED_COMPONENT_ORDER = ['entry', 'stopLoss', 'profitTarget', 'positionSizing', 'instrument'];
...
// ============================================================================
// COMPACT VALIDATION BADGE (for chat messages)
// ============================================================================
