    ...
    <div className="min-h-screen bg-bg-primary pb-20">
      ...
      <header className="sticky top-0 z-40 bg-bg-primary/80 backdrop-blur-xl border-b border-line-subtle">
        <div className="px-4 py-4 flex items-center gap-3">
          ...
          <div className="font-display font-bold text-lg">AI Strategy Chat</div>
        </div>
      </header>
      ...
      <main className="px-4 py-6">
        <div className="card text-center py-16">
          ...
          <p className="text-content-tertiary text-sm max-w-sm mx-auto mb-6">
            Describe your strategy in plain English. Our AI will parse it and set up 
            perfect execution for your prop challenge.
          </p>
