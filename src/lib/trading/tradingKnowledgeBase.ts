 ...
 * 
 * NOTE: This is for Claude EDUCATION (prompt content), not runtime validation.
 * For UI validation, use src/lib/strategy/strategyValidator.ts
 */
...
/**
 * PROP FIRM STANDARDS (Embedded for Claude Context)
 * 
 * NOTE: For UI business logic/enforcement, use src/lib/firm-rules/loader.ts
 * This is for Claude to understand and educate users about firm requirements.
 */
...
export type EntryType = keyof typeof ENTRY_TAXONOMY;
export type InstrumentType = keyof typeof INSTRUMENTS;
export type PropFirmName = keyof typeof PROP_FIRM_STANDARDS;
export type MistakeType = keyof typeof COMMON_MISTAKES;
